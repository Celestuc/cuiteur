(function() {
	...
	FP.init({tutoID: 'PHP',
			...
			mailTo: 'eric.merlet@univ-fcomte.fr',
			Video: {
				height: 360,
				width: 480,
	...
	FP.addPage({titre: 'Variables développeur',
				resume: 'Variables définies par le développeur. Typage, nommage, portées. Gestion des variables en mémoire.',
				rep: dossier,
				fic: 'php01b1',
				chap: numChap});
	...
	FP.addPage({titre: 'Types de données',
				resume: 'Types de données supportés par PHP.',
				rep: dossier,
				fic: 'php01b3',
				chap: numChap});
	...
	FP.addPage({titre: 'Les fonctions',
				...
				fic: 'php01e1',
				chap: numChap});
	FP.addPage({titre: 'Paramètres des fonctions',
				resume: 'Valeurs par défaut. Arguments nommés.Nombre variable. Mode de transmission',
				rep: dossier,
				fic: 'php01e2',
				chap: numChap,
				exos: [
	...
	FP.addPage({titre: 'Déclaration de type',
				resume: 'Syntaxe. Conversion dans le type indiqué. Type nullable. Unions de types.',
				rep: dossier,
				fic: 'php01e4',
				chap: numChap,
				exos: [ ['exo_declaration_type', 'Déclaration de type']
					]});
	...
	FP.addPage({titre: 'Inclure du code externe',
				resume: 'Inclure du code stocké dans d\'autres fichiers. Bibliothèques de fonctions. Commentaires PHPDoc.',
				rep: dossier,
				fic: 'php01e7',
				chap: numChap,
				exos: [
	...
	FP.addPage({titre: 'Codage des caractères',
				resume: 'Codage ASCII. Codages ASCII étendus (sur 8 bits). La norme Unicode et le codage UTF-8',
				rep: dossier,
				fic: 'php03a0',
				chap: numChap});
	...
	FP.addPage({titre: 'Longueur, Unicode, UTF-8, et espaces blancs',
				resume: 'Nombre de octets/caractères dans une chaîne. Eliminer les espaces blancs.',
				rep: dossier,
				fic: 'php03b1',
				chap: numChap});
	...
	FP.addPage({titre: 'Protection des chaînes',
				resume: 'Attaques XSS. Neutraliser ou supprimer les tags HTML. Protéger les caractères pour SQL.',
				rep: dossier,
				fic: 'php03c1',
				chap: numChap});
	...
	FP.addPage({titre: 'Les formulaires',
				...
				fic: 'php06a2',
				chap: numChap});
	FP.addPage({titre: 'Validation des données reçues',
				resume: 'Vérification coté serveur. Vérification  des clés et dans $_GET et $_POST. Validation des zones numériques, des zones de saisie libre, et des zones non saisies.',
				rep: dossier,
				fic: 'php06a3',
				chap: numChap});
...
// 				chap: numChap});
	...
	FP.addPage({titre: 'Les liens',
				resume: 'Utiliser les urls des liens pour passer des informations. Chiffrement et ajout d\'une signature.',
				rep: dossier,
				fic: 'php06b5',  // ATTENTION au numéro (ordre non respecté)
				chap: numChap});
	...
	FP.TChap[numChap] = new FP.Chapitre('MySQL / MariaDB',numChap);
	FP.addPage({titre: 'Présentation de MySQL / MariaDB',
	...
	FP.addPage({titre: 'Mise à jour - Liste',
				resume: 'Liste des enregistrements recherchés et choix pour mise à jour. Chiffrement des paramètres d\'un lien.',
				rep: dossier,
				fic: 'php07d3',
				chap: numChap});
	...
	FP.addPage({titre: 'Chemin vers un fichier',
	...
	FP.TChap[numChap] = new FP.Chapitre('Objets',numChap);
		FP.addPage({titre: 'Syntaxe de base',
				...
				chap: numChap,
				exos: [
						['exoClasseLivre', 'Définir et instancier une classe']
					]});
	...
	FP.addPage({titre: 'Constructeur et destructeur',
				...
				chap: numChap,
				exos: [
						['exoConstructeur1', 'Validation des paramètres'],
						['exoConstructeur2', 'Tableau de paramètres'],
						['exoDestructeur', 'Classe BDD']
					]});
	FP.addPage({titre: 'Membres statiques et constantes',
				resume: 'Définir des membres statiques et des constantes et les utiliser avec l\'opérateur de résolution de portée ::',
				rep: dossier,
				fic: 'php10a4',
				chap: numChap,
				exos: [
	...
	FP.addPage({titre: 'Héritage - principes',
				...
				fic: 'php10b1',
				chap: numChap});
	FP.addPage({titre: 'Héritage - Redéfinition',
				resume: 'Redéfinition de méthodes.',
				rep: dossier,
				fic: 'php10b2',
				chap: numChap,
				exos: [
	...
	FP.TChap[numChap] = new FP.Chapitre('Expressions régulières',numChap);
		FP.addPage({titre: 'Présentation',
				resume: 'Que sont les expressions régulières ?',
				rep: dossier,
				fic: 'php04a1',
				chap: numChap});

	FP.addPage({titre: 'Règles de base',
				resume: 'Construire une expression régulière atomique, opérateur ou, énumération, listes définies via un intervalle, classes de caractères prédéfinies, métacaractères point et backslash.',
				rep: dossier,
				fic: 'php04a2',
				chap: numChap});

	FP.addPage({titre: 'Répétitions fixées',
				resume: 'Définir des répétitions fixées d\'expressions atomiques ou de sous-motifs.',
				rep: dossier,
				fic: 'php04b1',
				chap: numChap,
	...
	FP.addPage({titre: 'Répétitions délimitées',
				resume: 'Définir des répétitions d\'expressions atomiques ou de sous-motifs, dans des limites inférieure et éventuellement supérieure.',
				rep: dossier,
				fic: 'php04b2',
				chap: numChap});

	FP.addPage({titre: 'Sous-motifs',
				resume: 'Définir des sous-motifs dans une expression régulière.',
				rep: dossier,
				fic: 'php04b3',
				chap: numChap,
	...
	FP.addPage({titre: 'Parenthèses non capturantes. Références arrières.',
	...
	FP.addPage({titre: 'Remplacement de références arrières',
				resume: 'Les références arrières peuvent être utilisées dans le remplacement. Exemple : effet stabilo.',
				rep: dossier,
				fic: 'php04c4',
				chap: numChap});
	...
	FP.addPage({titre: 'Découper une chaîne',
				resume: 'Découper une chaîne en sous-chaînes avec les expressions régulières.',
				rep: dossier,
				fic: 'php04c6',
				chap: numChap});
	//=======================================================
